...
const testimonials = [
  { tempId: 0,  testimonial: "Flow Pilot cut our dispatch time in half. Our techs spend more time on-site and less time waiting for job details.", by: "Marcus, Operations Manager at ClearWater Plumbing", imgSrc: "https://i.pravatar.cc/150?img=1" },
  ...
  { tempId: 3,  testimonial: "We grew from 4 techs to 12 without adding any admin staff. Flow Pilot scaled right with us.", by: "Priya, Founder at ProFix Services", imgSrc: "https://i.pravatar.cc/150?img=4" },
  ...
  { tempId: 9,  testimonial: "We tried two other platforms before Flow Pilot. Nothing else comes close for field service.", by: "Kelly, Operations Lead at BrightSpark Electric", imgSrc: "https://i.pravatar.cc/150?img=10" },
  ...
  { tempId: 13, testimonial: "Flow Pilot's reporting showed us which jobs were actually profitable. That insight alone paid for the software.", by: "Helen, CFO at ServiceMax Electric", imgSrc: "https://i.pravatar.cc/150?img=14" },
  ...
  { tempId: 17, testimonial: "We handle twice the job volume with the same team. Flow Pilot is the only reason that's possible.", by: "Ben, Director at GreenMark Landscaping", imgSrc: "https://i.pravatar.cc/150?img=18" },
  ...
  { tempId: 19, testimonial: "If you run a field service business and you're not on Flow Pilot, you are leaving money on the table.", by: "Eric, Owner at Summit Electrical", imgSrc: "https://i.pravatar.cc/150?img=20" },
]
