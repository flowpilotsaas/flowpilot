...
type InfiniteSliderProps = {
  ...
  gap?: number;
  /** Total animation duration in seconds (lower = faster). Alias: speed */
  duration?: number;
  /** Alias for duration — accepts the prop name used in logo-cloud demos */
  speed?: number;
  durationOnHover?: number;
  /** Alias for durationOnHover */
  speedOnHover?: number;
